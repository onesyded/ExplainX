...
export default function OnboardingScreen({ onComplete }: OnboardingScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col">
        <h2 className="text-2xl font-black text-[#0D1E36] mb-2 tracking-tight">Complete Profile</h2>
        <p className="text-slate-500 mb-6 text-sm font-medium">Select your current academic standing to tailor your content.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full bg-[#0D1E36] text-white font-bold py-3 px-4 rounded-xl hover:bg-slate-800 transition-colors mt-4 shadow-sm"
          >
